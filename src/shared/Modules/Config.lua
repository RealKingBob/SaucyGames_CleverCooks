return {
    ...
    DEFAULT_SANDBOX_TIME = 100; --in seconds | Default Time: 900;
    DEFAULT_NIGHT_TIME = 50; --in seconds | Default Time: 360;
    ...
    DAY_START_SHIFT = 9; --// 9 AM
    DAY_END_SHIFT = 17; --// 5 PM
    NIGHT_START_SHIFT = 0; --// 12 AM
    NIGHT_END_SHIFT = 6; --// 6 AM
