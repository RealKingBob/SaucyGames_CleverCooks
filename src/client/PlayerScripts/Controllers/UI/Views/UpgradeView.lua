...
function UpgradeView:SetupUpgradeTabs()
    ...
    ResetButton.MouseButton1Click:Connect(function()
        ...
        local ResultInfo = ProgressionService:ResetProgressionData(ThemeData)
        print(ResultInfo)
    ...
    for progressionName, progressionData in next, ProgressionStorage do
        ...
        local ItemClone = ProgressItemPrefab:Clone() do
            ...
            ItemClone:WaitForChild("Button").MouseButton1Click:Connect(function()
                ...
                local Coins, newProgressionData = DataService:GetCurrency(ThemeData)
                ...
                if (CanAfford) then
                    local ResultInfo = ProgressionService:PurchaseUpgrade(ThemeData, progressionName)
                    print(ResultInfo)
