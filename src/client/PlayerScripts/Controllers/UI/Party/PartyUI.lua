...
local PartyButtonView = PlayerGui:WaitForChild("LeftBar"):WaitForChild("MainContainer"):WaitForChild("Main"):WaitForChild("Party");

local PartyView = PlayerGui:WaitForChild("Views"):WaitForChild("Party");
...
function PartyUI:RefreshPartyMembers()
    ...
    PartyButtonView:WaitForChild("Main"):FindFirstChild("Title").Text = "(".. tostring(memberCount) .."/10)"
