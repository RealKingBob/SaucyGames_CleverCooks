...
Players.LocalPlayer.PlayerScripts:WaitForChild("RbxCharacterSounds").Disabled = true
...
local function initializeSoundSystem(player: Player, humanoid: Humanoid, rootPart: BasePart)
	...
	local stateTransitions: {[Enum.HumanoidStateType]: () -> ()} = {
		...
		[Enum.HumanoidStateType.Running] = function()
			if CollectionService:HasTag(script.Parent.Parent.Parent, "Hunter") then
				--[[stopPlayingLoopedSounds(sounds.HunterRunning)
				sounds.HunterRunning.Playing = true
				playingLoopedSounds[sounds.HunterRunning] = true]]
			else
