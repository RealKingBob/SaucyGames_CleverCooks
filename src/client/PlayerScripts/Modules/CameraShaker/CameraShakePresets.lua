...
local CameraShakePresets = {
	...
	-- Should happen once.
	Bump = function()
		local c = CameraShakeInstance.new(.75, 4, 0.1, 0.75)
		c.PositionInfluence = Vector3.new(0.15, 0.15, 0.15) / 2
		c.RotationInfluence = Vector3.new(1, 1, 1) / 2
		return c
	end;
	...
	-- Should happen once.
	Explosion = function()
		local c = CameraShakeInstance.new(5, 10, 0, 1.5 / 2)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25) / 3
		c.RotationInfluence = Vector3.new(4, 1, 1) / 3
		return c
	end;
	...
	-- Sustained.
	Earthquake = function()
		local c = CameraShakeInstance.new(1, 3, .25, .5)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25) / 2 
		c.RotationInfluence = Vector3.new(1, 1, 1) / 2
		return c
	end;
	...
	-- Sustained.
	Vibration = function()
		local c = CameraShakeInstance.new(0.4, 20, .25, .5)
