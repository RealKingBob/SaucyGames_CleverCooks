...
function Environment:SetLighting()
    ...
    local LightingInfo = MapSettings.HexagonStadium.Lighting;
    print("[Hexagon/Environment]:","Setting Up Lighting!")
...
function Environment:SetMap()
    ...
    local MapObject = ServerStorage.Stadiums["Hexagon"];
    print("[Hexagon/Environment]:","Setting Up Map!");
    if CurrentMap then
