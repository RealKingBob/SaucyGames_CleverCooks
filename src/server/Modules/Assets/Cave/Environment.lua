...
function Environment:SetLighting()
    ...
    local LightingInfo = MapSettings.Cave.Lighting;
...
function Environment:SetMap()
    ...
    local MapObject = ServerStorage.Maps["Cave"];
    print("[Cave/Environment]:","Setting Up Map!");
    if CurrentMap then
    ...
    --// Islands Sections
    local MainSection = {"Stage 3 [SPIKES 2]", "Stage 3 [SPIKES]", "Stage 3 [WALL ROCKS]"};
