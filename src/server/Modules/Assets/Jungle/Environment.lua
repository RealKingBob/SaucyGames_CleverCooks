...
function Environment:SetLighting()
    ...
    local LightingInfo = MapSettings.Jungle.Lighting;
...
function Environment:SetMap()
    ...
    local MapObject = ServerStorage.Maps["Jungle"];
    print("[Jungle/Environment]:","Setting Up Map!");
    if CurrentMap then
    ...
    --// Islands Sections
    local MainSection = {"Stage 5 [LOGS]", "Stage 5 [NUTCRACKER]"};
