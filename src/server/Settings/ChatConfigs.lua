-- BetterChatV3 made by @Jumpathy (4/2/22)
...
return {
	...
	TextColors = {
		Ranks = {
			[4] = Color3.fromRGB(255, 204, 0) --> Assign the owner role a golden text color
		},
		Users = {
	...
	NameColors = {
		Ranks = {
			[4] = Color3.fromRGB(255, 0, 0) --> Assign the owner of the game with a yellow name color
		},
		Users = {
	...
	UI = {
		...
		Resizable = false, --> Can the user resize their chat?
	...
	BubbleChat = {
		...
		Config = {
			...
			BubbleBackgroundColor = Color3.fromRGB(25,25,25), --> The chat bubble's background color.
			BubbleTextColor = Color3.fromRGB(255,255,255), --> The chat bubble's text color.
			Roundness = 40, --> The chat bubble's roundness in pixels
		}
	},
	SettingsMenu = { --> Settings for the chat's interface
		...
		TopbarButton = {
			Enabled = false, --> If it's enabled, do you want a topbar button for it? If not, you can use "/settings" to open the menu.
